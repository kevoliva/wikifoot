...
/**
 * @ApiResource(
 *     normalizationContext={"groups"={"competition:read", "country:read"}},
 *     denormalizationContext={"groups"={"competition:write", "country:write"}}
 * )
 * @ApiFilter(
...
class Competition
{
     ...
     * @Groups({"competition:read", "country:read"})
     */
    private $id;
